...
"")
        ...
        self.frame_6.setGeometry(QtCore.QRect(100, 240, 250, 230))
...
"border-radius: 5px;")
        ...
        self.lineEdit_quabtidade = QtWidgets.QSpinBox(self.login_conteudo)
        self.lineEdit_quabtidade.setObjectName("lineEdit_quabtidade")
        self.verticalLayout_3.addWidget(self.lineEdit_quabtidade)
