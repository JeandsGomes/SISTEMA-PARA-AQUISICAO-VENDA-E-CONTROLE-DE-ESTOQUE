...
"")
        ...
        self.textEdit_tabela_produto = QtWidgets.QTextEdit(self.frame_2)
        self.textEdit_tabela_produto.setGeometry(QtCore.QRect(20, 30, 401, 121))
        self.textEdit_tabela_produto.setStyleSheet("border-radius: 5px;\n"
"padding 15px;\n"
"background-color: rgb(221,221,221);\n"
"color: rgb(0, 0, 0);")
        self.textEdit_tabela_produto.setObjectName("textEdit_tabela_produto")
...
"border-radius: 5px;")
        ...
        self.lineEdit_data_fabricacao = QtWidgets.QLineEdit(self.frame_11)
        self.lineEdit_data_fabricacao.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_data_fabricacao.setStyleSheet("border-width: 1px;\n"
"border-color: black;\n"
"border-style: solid;\n"
"display: inline-block;\n"
"border-radius: 5px;")
        self.lineEdit_data_fabricacao.setObjectName("lineEdit_data_fabricacao")
        self.verticalLayout_8.addWidget(self.lineEdit_data_fabricacao)
        self.lineEdit_data_vencimento = QtWidgets.QLineEdit(self.frame_11)
        self.lineEdit_data_vencimento.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_data_vencimento.setStyleSheet("border-width: 1px;\n"
"border-color: black;\n"
"border-style: solid;\n"
"display: inline-block;\n"
"border-radius: 5px;")
        self.lineEdit_data_vencimento.setText("")
        self.lineEdit_data_vencimento.setObjectName("lineEdit_data_vencimento")
        self.verticalLayout_8.addWidget(self.lineEdit_data_vencimento)
...
"border-radius: 5px;")
        ...
        self.lineEdit_quantidade = QtWidgets.QLineEdit(self.frame_10)
        self.lineEdit_quantidade.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_quantidade.setStyleSheet("border-width: 1px;\n"
"border-color: black;\n"
"border-style: solid;\n"
"display: inline-block;\n"
"border-radius: 5px;")
        self.lineEdit_quantidade.setObjectName("lineEdit_quantidade")
        self.verticalLayout_7.addWidget(self.lineEdit_quantidade)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_data_fabricacao.setPlaceholderText(_translate("MainWindow", "Data de fabricação"))
        self.lineEdit_data_vencimento.setPlaceholderText(_translate("MainWindow", "Data de Vencimento"))
