...
# Form implementation generated from reading ui file '.\menu_busca_modifica_cliente.ui'
#
...
class Tela_Cliente_Busca_Modifica(object):
...
"")
        ...
        self.lineEdit_busca_cpf = QtWidgets.QLineEdit(self.frame_2)
        self.lineEdit_busca_cpf.setGeometry(QtCore.QRect(100, 60, 181, 30))
        self.lineEdit_busca_cpf.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_busca_cpf.setStyleSheet("border-width: 1px;\n"
"border-color: black;\n"
"border-style: solid;\n"
"display: inline-block;\n"
"border-radius: 5px;")
        self.lineEdit_busca_cpf.setText("")
        self.lineEdit_busca_cpf.setObjectName("lineEdit_busca_cpf")
        self.pushButton_buscar = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_buscar.setGeometry(QtCore.QRect(290, 60, 50, 30))
...
"")
        ...
        self.frame_6.setGeometry(QtCore.QRect(10, 100, 421, 371))
...
"border-radius: 5px;")
        ...
        self.lineEdit_nome = QtWidgets.QLineEdit(self.login_conteudo)
        self.lineEdit_nome.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_nome.setStyleSheet("border-width: 1px;\n"
"border-color: black;\n"
"border-style: solid;\n"
"display: inline-block;\n"
"border-radius: 5px;")
...
"border-radius: 5px;")
        ...
        self.lineEdit_nascimento = QtWidgets.QDateEdit(self.frame_12)
        self.lineEdit_nascimento.setObjectName("lineEdit_nascimento")
        self.horizontalLayout_3.addWidget(self.lineEdit_nascimento)
...
"border-radius: 5px;")
        ...
        self.pushButton_atualizar = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_atualizar.setGeometry(QtCore.QRect(30, 170, 161, 50))
        self.pushButton_atualizar.setMinimumSize(QtCore.QSize(0, 50))
        self.pushButton_atualizar.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.pushButton_remover = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_remover.setGeometry(QtCore.QRect(240, 170, 161, 50))
        self.pushButton_remover.setMinimumSize(QtCore.QSize(0, 50))
        self.pushButton_remover.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_remover.setFont(font)
        self.pushButton_remover.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_remover.setStyleSheet("QPushButton{\n"
"    border-radius: 10px;\n"
"    border-image: url(:/Close_Image/cil-x.png);\n"
"    background-position: center;\n"
"        \n"
...
"")
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 30, 301, 16))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_busca_cpf.setPlaceholderText(_translate("MainWindow", "CPF do Cliente"))
        self.pushButton_buscar.setText(_translate("MainWindow", "Buscar"))
        self.lineEdit_cpf.setPlaceholderText(_translate("MainWindow", "CPF (Obrigatorio na remoção)"))
        self.lineEdit_nome.setPlaceholderText(_translate("MainWindow", "Nome completo"))
        ...
        self.lineEdit_telefone.setPlaceholderText(_translate("MainWindow", "Numero de Telefone"))
        self.pushButton_atualizar.setText(_translate("MainWindow", "Atualizar Cliente"))
        self.pushButton_remover.setText(_translate("MainWindow", "Remover Cliente"))
        self.label_2.setText(_translate("MainWindow", "Atualizar, Remoção ou Buscar Cliente"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MainWindow = QtWidgets.QMainWindow()
    ui = Tela_Cliente_Busca_Modifica()
