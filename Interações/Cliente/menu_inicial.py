...
"")
        ...
        self.textEdit_tabela_vendas = QtWidgets.QTextEdit(self.frame_2)
        self.textEdit_tabela_vendas.setGeometry(QtCore.QRect(20, 40, 401, 151))
        self.textEdit_tabela_vendas.setStyleSheet("border-radius: 5px;\n"
"padding 15px;\n"
"background-color: rgb(221,221,221);\n"
"color: rgb(0, 0, 0);")
        self.textEdit_tabela_vendas.setObjectName("textEdit_tabela_vendas")
        ...
        self.frame_6.setGeometry(QtCore.QRect(100, 240, 250, 234))
...
"border-radius: 5px;")
        ...
        self.lineEdit_quabtidade = QtWidgets.QLineEdit(self.login_conteudo)
        self.lineEdit_quabtidade.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_quabtidade.setStyleSheet("border-width: 1px;\n"
"border-color: black;\n"
"border-style: solid;\n"
"display: inline-block;\n"
"border-radius: 5px;")
...
"border-radius: 5px;")
        ...
        self.lineEdit_index_forma_pagamento = QtWidgets.QLineEdit(self.login_conteudo)
        self.lineEdit_index_forma_pagamento.setMinimumSize(QtCore.QSize(0, 30))
        self.lineEdit_index_forma_pagamento.setStyleSheet("border-width: 1px;\n"
"border-color: black;\n"
"border-style: solid;\n"
"display: inline-block;\n"
"border-radius: 5px;")
        self.lineEdit_index_forma_pagamento.setObjectName("lineEdit_index_forma_pagamento")
        self.verticalLayout_3.addWidget(self.lineEdit_index_forma_pagamento)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_quabtidade.setPlaceholderText(_translate("MainWindow", "Quantidade"))
        self.lineEdit_index_cliente.setPlaceholderText(_translate("MainWindow", "Index do cliente"))
        self.lineEdit_index_forma_pagamento.setPlaceholderText(_translate("MainWindow", "Forma de Pagamento"))
